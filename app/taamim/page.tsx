  ...
  return (
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    #trad-learn-btn {
      background: none; border: 0.5px solid #ccc; border-radius: 16px; cursor: pointer; padding: 4px 14px;
      font-family: 'TheBasics', sans-serif; font-size: 17px; color: #aaa;
      pointer-events: all; transition: color 0.15s, border-color 0.15s;
      position: absolute; bottom: -2px; left: 130px;
    }
    #trad-learn-btn:hover, #trad-learn-btn.learning { color: #FF179C; border-color: #FF179C; }
    body.dark #trad-learn-btn { color: #555; border-color: #555; }
    body.dark #trad-learn-btn.learning { color: #FF179C; border-color: #FF179C; }
...
<nav className="navbar">
  ...
  <div id="tradition-wrap">
    ...
    <button id="trad-learn-btn">הגדר MIDI</button>
    <div id="trad-col">
      <div id="trad-list">
