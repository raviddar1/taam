      ...
      function onMidiMsg(msg){
        ...
        unlockAudio();
          ...
          if((st&0xF0)===0x90&&vel>0){
            ...
            if(note===nR&&nRt==='note'){ if(typeof window._hidePadGrid==='function') window._hidePadGrid(); flashArrow('pnav-next','arrow-flash-right');  navPage(-1); return; }
            if(note===nL&&nLt==='note'){ if(typeof window._hidePadGrid==='function') window._hidePadGrid(); flashArrow('pnav-prev','arrow-flash-left'); navPage(1);  return; }
            return;
          }
          ...
          if((st&0xF0)===0xB0){
            ...
            if(cc===nR&&nRt==='cc'){ const on=val>0.5; if(on&&!_nRprev){ if(typeof window._hidePadGrid==='function') window._hidePadGrid(); flashArrow('pnav-next','arrow-flash-right');  navPage(-1); } _nRprev=on; return; }
            if(cc===nL&&nLt==='cc'){ const on=val>0.5; if(on&&!_nLprev){ if(typeof window._hidePadGrid==='function') window._hidePadGrid(); flashArrow('pnav-prev','arrow-flash-left'); navPage(1);  } _nLprev=on; return; }
